...
class mexc(Exchange, ImplicitAPI):
                ...
                'spot': {
                    ...
                    'private': {
                        'get': [
                            ...
                            'capital/withdraw/address',
                            'capital/deposit/address',
                            'capital/transfer',
                            'capital/transfer/tranId',
                            'capital/transfer/internal',
                            ...
                            'rebate/referCode',
                            'rebate/affiliate/commission',
                            'rebate/affiliate/withdraw',
    ...
    def is_spot(self):
        _type = self.safe_value(self.options, 'defaultType')
        return _type == "spot"
    ...
    def fetch_markets(self, params={}):
        ...
        """
        spot_market, swap_market = list(), list()
        if self.is_spot():
            spot_market = self.fetch_spot_markets(params)
        if self.is_swap():
            swap_market = self.fetch_swap_markets(params)
        return self.array_concat(spot_market, swap_market)
    ...
    def fetch_spot_markets(self, params={}):
        ...
        for i in range(0, len(data)):
            ...
            allow_market = "MARKET" in order_types
            active = status == 'ENABLED'
            active_for_trading = isSpotTradingAllowed
