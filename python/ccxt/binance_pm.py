...
class binance_pm(Exchange, ImplicitAPI):
    ...
    def describe(self):
        return self.deep_extend(super(binance_pm, self).describe(), {
            ...
            'api': {
                ...
                'sapi': {
                    ...
                    'get': {
                        ...
                        'margin/crossMarginData': 0.1,
                        'margin/isolatedMarginData': 0.1,
                ...
                'papi': {
                    ...
                    'get': {
                        ...
                        'um/conditional/openOrders': 1,
                        'um/conditional/orderHistory': 1,
                        'um/conditional/allOrders': 1,
                        'cm/conditional/openOrder': 1,
                        'cm/conditional/openOrders': 1,
            ...
            'currencies': {
                'BNFCR': self.safe_currency_structure({'id': 'BNFCR', 'code': 'BNFCR',
    ...
    def fetch_markets(self, params={}) -> List[Market]:
        ...
        rawFetchMarkets = ['linear' if defaultType == 'future' else 'inverse' if defaultType == 'delivery' else 'spot']
    ...
    def fetch_balance(self, params={}) -> Balances:
        ...
        isPortfolioMargin = self.safe_bool(self.options, 'portfolioMargin', True)
        marginMode = None
        query = None
